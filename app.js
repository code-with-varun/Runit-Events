...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Home Button Handlers (Return to Countdown / Initial Screen)
  ...
  // ============================================================
  // 3. SLIDE DECK RENDERER (19 KEYNOTE SLIDES)
  // ============================================================
  ...
  // Dropdown Options (Slide 8 is Organization Overview, Slide 17 is Team & Core Community Roster)
  const slideTitles = [
    "1. RUNIT ONEVIA 2026",
    "2. Welcome Message",
    "3. Event Agenda",
    ...
    "9. Product Portfolio Overview",
    "10. Orbita Showcase",
    "11. PowerBooks Showcase",
    "12. MoneyMatrix Rebrand",
    "13. ISPARK Platform",
    "14. MIS Reporting Services",
    "15. 5-Year Product Roadmap",
    "16. Product Strategy Matrix",
    "17. Team & Core Community Roster",
    "18. Quarterly Rhythm & Objectives",
    "19. Thank You & Open Discussion"
  ];
  ...
  function renderSlide(index) {
    ...
    switch (index) {
      case 0: // Cover Slide
        html = `
          <div class="slide-header">
            ...
            <span class="slide-number">Slide 1 of 19</span>
          </div>
      ...
      case 1: // Welcome Message
        html = `
          <div class="slide-header">
            ...
            <span class="slide-number">Slide 2 of 19</span>
          </div>
      ...
      case 2: // Event Agenda
        html = `
          <div class="slide-header">
            ...
            <span class="slide-number">Slide 3 of 19</span>
          </div>
      ...
      case 3: // Why Runit Exists
        html = `
          <div class="slide-header">
            ...
            <span class="slide-number">Slide 4 of 19</span>
          </div>
      ...
      case 4: // About Runit Infotech
        html = `
          <div class="slide-header">
            ...
            <span class="slide-number">Slide 5 of 19</span>
          </div>
      ...
      case 5: // Our Journey
        html = `
          <div class="slide-header">
            ...
            <span class="slide-number">Slide 6 of 19</span>
          </div>
      ...
      case 6: // Mission & Vision
        html = `
          <div class="slide-header">
            ...
            <span class="slide-number">Slide 7 of 19</span>
          </div>
      ...
      case 7: // Slide 8: Organization Overview & Community Vision
        html = `
          <div class="slide-header">
            ...
            <span class="slide-number">Slide 8 of 19</span>
          </div>
      ...
      case 8: // Product Portfolio Overview
        html = `
          <div class="slide-header">
            <span class="slide-tag">Product Ecosystem</span>
            <span class="slide-number">Slide 9 of 19</span>
          </div>
      ...
      case 9: // Orbita Spotlight
        html = renderProductSlide(d.products[0], 10);
        break;

      case 10: // PowerBooks Spotlight
        html = renderProductSlide(d.products[1], 11);
        break;

      case 11: // MoneyMatrix / Rebrand Spotlight
        html = `
          <div class="slide-header">
            <span class="slide-tag">Product Rebrand & Spotlight</span>
            <span class="slide-number">Slide 12 of 19</span>
          </div>
      ...
      case 12: // ISPARK Spotlight
        html = renderProductSlide(d.products[3], 13);
        break;

      case 13: // MIS Services Spotlight
        html = renderProductSlide(d.products[4], 14);
        break;

      case 14: // 5-Year Roadmap
        html = `
          <div class="slide-header">
            <span class="slide-tag">Strategic Vision</span>
            <span class="slide-number">Slide 15 of 19</span>
          </div>
      ...
      case 15: // Product Strategy Matrix
        html = `
          <div class="slide-header">
            <span class="slide-tag">Market Verticals</span>
            <span class="slide-number">Slide 16 of 19</span>
          </div>
      ...
      case 16: // Slide 17: Team & Core Community Roster (Moved to Slide 17 as requested!)
        html = `
          <div class="slide-header">
            <span class="slide-tag">Member Presentations</span>
            <span class="slide-number">Slide 17 of 19</span>
          </div>
      ...
      case 17: // Immediate Objectives & Runit Nextora Cadence
        html = `
          <div class="slide-header">
            <span class="slide-tag">Execution Cadence</span>
            <span class="slide-number">Slide 18 of 19</span>
          </div>
      ...
      case 18: // Merged Slide 19: Thank You, Open Discussion & Grand Finale
        html = `
          <div class="slide-header">
            <span class="slide-tag">Grand Finale</span>
            <span class="slide-number">Slide 19 of 19</span>
          </div>
          <div style="text-align: center; margin: auto 0;">
  ...
  function renderProductSlide(p, slideNum) {
    return `
      <div class="slide-header">
        ...
        <span class="slide-number">Slide ${slideNum} of 19</span>
      </div>
      <div class="product-spotlight">
        <div class="product-info">
          <div>
  ...
  // Navigation Controls (Keyboard & Mouse Scroll)
  ...
  // Detailed Team Member Modal (Profession-Tailored Content)
